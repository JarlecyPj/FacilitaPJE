...
const imageData = {
    ...
    consulta: [
        {
            src: 'imagens/PJE Opção Consulta Processo.png',
        ...
        {
            src: 'imagens/PJE Opções Processo corte.png',
            title: 'Visualizar Processo',
            description: 'Clique no processo para visualizar seus detalhes e andamento.',
            step: 3
        },
        {
            src: 'imagens/5 Consulta processo - segredo de justiça não sera exibido aqui deve-se pedir habilitação para a visualização.png',
        ...
        {
            src: 'imagens/PJE Opções do Menu Painel.png',
